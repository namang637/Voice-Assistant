...
const App = () => {
  ...
  const handleVoiceCommand = async (command) => {
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'm Leo, Your voice assistant created by Naman.";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello Leo")) {
      const response = "Hello Sir I'm Leo, How can i help you?";
      speakText(response);
      setInformation(response);
      return;
